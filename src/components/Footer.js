    ...
    <footer>
      <div className="footer-content">
        ...
        <div className="footer-section">
          <h4>서비스</h4>
          <ul>
            <li><a href="#auto">자동차보험 비교</a></li>
            <li><a href="#health">실손보험 비교</a></li>
            <li><a href="#cancer">암보험 비교</a></li>
            <li><a href="#calculator">보험료 계산기</a></li>
          </ul>
        </div>
        ...
        <div className="footer-section">
          ...
          <ul>
            ...
            <li><a href="#insurance-law">보험업법 안내</a></li>
            <li><a href="#consumer">금융소비자보호</a></li>
          </ul>
        </div>
      </div>
